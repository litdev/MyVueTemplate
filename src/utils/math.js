...
exports.install = function (Vue, options) {
     ...
     */
    const toInteger = function (floatNum) {
     ...
     */
    const operation = function (a, b, dig, op) {
        var o1 = toInteger(a)
        var o2 = toInteger(b)
        var n1 = o1.num
        var n2 = o2.num
     ...
     * @return {object} s位小数
     */
    const divide = function (a, b, s) {
        return operation(a, b, (s | 2), 'divide')
    }

    //必须放到最后面,调用方式：this.$match.isInteger('a');
    Vue.prototype.$math = {
        isInteger,
        toInteger,
        toFixed,
