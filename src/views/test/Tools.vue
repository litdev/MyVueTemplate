...
export default {
    ...
    created() {
        ...
        // console.log(this.$func.diffDateTime('2021/09/13 12:10:00','2021/09/13 12:20:00','am'));
        // console.log(this.$func.formatDate('2021/09/13 12:10:00','yyyy-MM-dd EE HH:mm:ss'));
        // console.log(this.$func.formatMoney(5255.511,2));
    },
    methods: {
        test() {},
    },
